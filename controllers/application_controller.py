...
class ApplicationController:
    def __init__(self):
        ...
        self.properties_controller = PropertiesController(self.window, r'C:\Users\glenn\DocTalker\properties.yaml', context_windows)

        # Adding tabs
        self.notebook.add(self.chat_sessions_controller.view, text="Chat")
